...
public class EditingPolygraphyModel {
    ...
    public EditingPolygraphyModel() {
    }

    public EditingPolygraphyModel(int polygraphyId, String email, String password, String name, String address,
