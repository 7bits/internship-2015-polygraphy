...
public class EditingPolygraphyForm {
    ...
    public EditingPolygraphyForm() {
    }

    public EditingPolygraphyForm(int polygraphyId, String email, String password, String name, String address,
