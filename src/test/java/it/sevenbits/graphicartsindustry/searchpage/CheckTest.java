...
//
//   //String USER = testResolver.getUsername();
//   // String Password = testResolver.getPassword();
//
//    WebDriver driver = new RemoteWebDriver(new URL(URL), caps);
//    driver.get("http://" + testResolver.getUsername() + ":" + testResolver.getPassword() + testResolver.getDomain());
